...
public class Evenements {
    ...
    public Evenements( Timestamp date_debut, int prix, 
            int age_min, int age_max, String lieu_depart, 
            String lieu_arrive, String equipement_ren, String moyen_transport_ren, String moyen_transport_t, String sites_principeaux, String equipements_camping) {
        this.date_debut = date_debut;
        this.prix = prix;
        this.age_min = age_min;
        this.age_max = age_max;
